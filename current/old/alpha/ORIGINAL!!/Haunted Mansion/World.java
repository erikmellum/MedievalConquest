...
public class World implements Serializable
{
	...
	public int getDamage(int damageModifier)
	{
		int damage = 0;
		if(damageModifier < 3)
			damage = 1;
			...
			damage = 4;
		else if(damageModifier < 15)
			damage = 5;
		else if(damageModifier < 18)
			damage = 6;
		else if(damageModifier < 21)
			damage = 7;
		else if(damageModifier < 24)
			damage = 8;
		else if(damageModifier < 27)
			damage = 9;
		else if(damageModifier < 30)
			damage = 10;
		else if(damageModifier < 33)
			damage = 11;
		else if(damageModifier < 36)
			damage = 12;
		else if(damageModifier < 39)
			damage = 13;
		else if(damageModifier < 42)
			damage = 14;
		else if(damageModifier < 45)
			damage = 15;
		else if(damageModifier < 48)
			damage = 16;
		else if(damageModifier < 51)
			damage = 17;
		else if(damageModifier < 54)
			damage = 18;
		else if(damageModifier < 57)
			damage = 19;
		else if(damageModifier < 60)
			damage = 20;
		else if(damageModifier < 63)
			damage = 21;
		else if(damageModifier < 66)
			damage = 22;
		else if(damageModifier < 69)
			damage = 23;
		else if(damageModifier < 72)
			damage = 24;
		else if(damageModifier < 75)
			damage = 25;
		else if(damageModifier < 78)
			damage = 26;
		else if(damageModifier < 81)
			damage = 27;
		else if(damageModifier < 84)
			damage = 28;
		else if(damageModifier < 87)
			damage = 29;
		else if(damageModifier < 90)
			damage = 30;
		else if(damageModifier < 93)
			damage = 31;
		else if(damageModifier < 96)
			damage = 32;
		else if(damageModifier < 99)
			damage = 33;
		else if(damageModifier < 102)
			damage = 34;
		else if(damageModifier < 105)
			damage = 35;
		else if(damageModifier < 108)
			damage = 36;
		else if(damageModifier < 111)
			damage = 39;
		else if(damageModifier < 114)
			damage = 42;
		else if(damageModifier < 117)
			damage = 45;
		else if(damageModifier < 120)
			damage = 48;
		else if(damageModifier < 123)
			damage = 51;
		else if(damageModifier < 126)
			damage = 54;
		else if(damageModifier < 129)
			damage = 57;
		else if(damageModifier < 132)
			damage = 60;
		else if(damageModifier < 135)
			damage = 63;
		else if(damageModifier < 138)
			damage = 66;
		else if(damageModifier < 141)
			damage = 69;
		else if(damageModifier < 144)
			damage = 72;
		return damage;
	}
	...
	{
		int accuracy = 0;
		if(accuracyModifier < 3)
			accuracy = 1;
		else if(accuracyModifier < 6)
			accuracy = 2;
		else if(accuracyModifier < 9)
			accuracy = 3;
		else if(accuracyModifier < 12)
			accuracy = 4;
		else if(accuracyModifier < 15)
			accuracy = 5;
		else if(accuracyModifier < 18)
			accuracy = 6;
		else if(accuracyModifier < 21)
			accuracy = 7;
		else if(accuracyModifier < 24)
			accuracy = 8;
		else if(accuracyModifier < 27)
			accuracy = 9;
		else if(accuracyModifier < 30)
			accuracy = 10;
		else if(accuracyModifier < 33)
			accuracy = 11;
		else if(accuracyModifier < 36)
			accuracy = 12;
		else if(accuracyModifier < 39)
			accuracy = 13;
		else if(accuracyModifier < 42)
			accuracy = 14;
		else if(accuracyModifier < 45)
			accuracy = 15;
		else if(accuracyModifier < 48)
			accuracy = 16;
		else if(accuracyModifier < 51)
			accuracy = 17;
		else if(accuracyModifier < 54)
			accuracy = 18;
		else if(accuracyModifier < 57)
			accuracy = 19;
		else if(accuracyModifier < 60)
			accuracy = 20;
		else if(accuracyModifier < 63)
			accuracy = 21;
		else if(accuracyModifier < 66)
			accuracy = 22;
		else if(accuracyModifier < 69)
			accuracy = 23;
		else if(accuracyModifier < 72)
			accuracy = 24;
		else if(accuracyModifier < 75)
			accuracy = 25;
		else if(accuracyModifier < 78)
			accuracy = 26;
		else if(accuracyModifier < 81)
			accuracy = 27;
		else if(accuracyModifier < 84)
			accuracy = 28;
		else if(accuracyModifier < 87)
			accuracy = 29;
		else if(accuracyModifier < 90)
			accuracy = 30;
		else if(accuracyModifier < 93)
			accuracy = 31;
		else if(accuracyModifier < 96)
			accuracy = 32;
		else if(accuracyModifier < 99)
			accuracy = 33;
		else if(accuracyModifier < 102)
			accuracy = 34;
		else if(accuracyModifier < 105)
			accuracy = 35;
		else if(accuracyModifier < 108)
			accuracy = 36;
		else if(accuracyModifier < 111)
			accuracy = 39;
		else if(accuracyModifier < 114)
			accuracy = 42;
		else if(accuracyModifier < 117)
			accuracy = 45;
		else if(accuracyModifier < 120)
			accuracy = 48;
		else if(accuracyModifier < 123)
			accuracy = 51;
		else if(accuracyModifier < 126)
			accuracy = 54;
		else if(accuracyModifier < 129)
			accuracy = 57;
		else if(accuracyModifier < 132)
			accuracy = 60;
		else if(accuracyModifier < 135)
			accuracy = 63;
		else if(accuracyModifier < 138)
			accuracy = 66;
		else if(accuracyModifier < 141)
			accuracy = 69;
		else if(accuracyModifier < 144)
			accuracy = 72;
		return accuracy;
	}
}
