...
public class Room implements Serializable
{
	 ...
	 */
	public Character getCharacter(Character theCharacter)
	{
		return characters.get(characters.indexOf(theCharacter));
	}
	/**
	...
	{
		characters.remove(characters.indexOf(theCharacter));
	}
	/**
	...
	public String toString()
	{
		...
		{
			output += "Characters: " ;
			for(Character toString: characters)
